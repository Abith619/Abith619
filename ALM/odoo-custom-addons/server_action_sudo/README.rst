...
This module enables you to execute action as a specific user as well as option to silently execute record update.


Usage
=====

Navigate to the server action form and configure your action
