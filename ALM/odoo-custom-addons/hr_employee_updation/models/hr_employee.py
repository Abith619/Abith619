...
class HrEmployeeFamilyInfo(models.Model):
    ...
    relation = fields.Selection([('father', 'Father'),
                                 ...
                                 ('daughter', 'Daughter'),
                                 ('son', 'Son'),
                                 ('wife', 'Wife'),('husband', 'Husband '),('brother', 'Elder Brother')
                                 ,('younger_brother', 'Younger Brother'),('elder_sister', 'Elder Sister'),('sister', 'Younger Sister')], string='Relationship', help='Relation with employee')
