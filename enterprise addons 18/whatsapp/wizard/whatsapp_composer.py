...
class WhatsAppComposer(models.TransientModel):
    ...
    # documents
    attachment_id : fields.Many2one = fields.Many2one('ir.attachment', index=True)
    ...
    wa_template_id : fields.Many2one = fields.Many2one(comodel_name="whatsapp.template", string="Template")
