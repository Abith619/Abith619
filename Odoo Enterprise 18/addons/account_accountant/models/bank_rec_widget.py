...
class BankRecWidget(models.Model):
    ...
    def _validation_lines_vals(self, line_ids_create_command_list, aml_to_exchange_diff_vals, to_reconcile):
        ...
        if len(partners) == 1 and partners.company_id == partners.company_id.root_id:
            # To avoid "Incompatible companies on records" error, make sure the user is linked to the main company
