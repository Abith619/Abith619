...
# Generate dataset to print a matrix : print(matrix(runif(6*3), n row=6, n col=3))
# create imputer object: impute = SimpleImpute(missing_values=np.nan, Strategy=‘most_frequent’)
# impute.fit_transform(x)
# Declare an object df = pd.dataframe() to create pandas dataframe
# df = pd.dataframe()
"""
