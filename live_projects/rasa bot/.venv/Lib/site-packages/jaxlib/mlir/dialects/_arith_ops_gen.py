...
class TruncFOp(_ods_ir.OpView):
  ...
  def __init__(self, out, in_, *, roundingmode=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def truncf(out, in_, *, roundingmode=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(TruncFOp(out=out, in_=in_, roundingmode=roundingmode, loc=loc, ip=ip))
