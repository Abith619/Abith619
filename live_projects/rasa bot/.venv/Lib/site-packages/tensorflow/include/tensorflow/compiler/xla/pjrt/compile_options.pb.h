...
inline bool ExecutableBuildOptionsProto::_internal_allow_spmd_sharding_propagation_to_output() const {
...
inline void ExecutableBuildOptionsProto::_internal_set_allow_spmd_sharding_propagation_to_output(bool value) {
