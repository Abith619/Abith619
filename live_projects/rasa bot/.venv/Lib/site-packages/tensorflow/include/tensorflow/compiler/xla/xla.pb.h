...
inline void DebugOptions::clear_xla_gpu_enable_mlir_lowering() {
  _impl_.xla_gpu_enable_mlir_lowering_ = false;
}
inline bool DebugOptions::_internal_xla_gpu_enable_mlir_lowering() const {
  return _impl_.xla_gpu_enable_mlir_lowering_;
}
...
inline void DebugOptions::_internal_set_xla_gpu_enable_mlir_lowering(bool value) {
  ...
  _impl_.xla_gpu_enable_mlir_lowering_ = value;
}
...
// bool xla_gpu_enable_softmax_fusion = 179;
inline void DebugOptions::clear_xla_gpu_enable_softmax_fusion() {
  _impl_.xla_gpu_enable_softmax_fusion_ = false;
}
inline bool DebugOptions::_internal_xla_gpu_enable_softmax_fusion() const {
  return _impl_.xla_gpu_enable_softmax_fusion_;
}
inline bool DebugOptions::xla_gpu_enable_softmax_fusion() const {
  // @@protoc_insertion_point(field_get:xla.DebugOptions.xla_gpu_enable_softmax_fusion)
  return _internal_xla_gpu_enable_softmax_fusion();
}
inline void DebugOptions::_internal_set_xla_gpu_enable_softmax_fusion(bool value) {
  
  _impl_.xla_gpu_enable_softmax_fusion_ = value;
}
inline void DebugOptions::set_xla_gpu_enable_softmax_fusion(bool value) {
  _internal_set_xla_gpu_enable_softmax_fusion(value);
  // @@protoc_insertion_point(field_set:xla.DebugOptions.xla_gpu_enable_softmax_fusion)
}
...
// bool xla_gpu_enable_cuda_graphs = 180;
inline void DebugOptions::clear_xla_gpu_enable_cuda_graphs() {
  _impl_.xla_gpu_enable_cuda_graphs_ = false;
}
inline bool DebugOptions::_internal_xla_gpu_enable_cuda_graphs() const {
  return _impl_.xla_gpu_enable_cuda_graphs_;
}
inline bool DebugOptions::xla_gpu_enable_cuda_graphs() const {
  // @@protoc_insertion_point(field_get:xla.DebugOptions.xla_gpu_enable_cuda_graphs)
  return _internal_xla_gpu_enable_cuda_graphs();
}
inline void DebugOptions::_internal_set_xla_gpu_enable_cuda_graphs(bool value) {
  
  _impl_.xla_gpu_enable_cuda_graphs_ = value;
}
inline void DebugOptions::set_xla_gpu_enable_cuda_graphs(bool value) {
  _internal_set_xla_gpu_enable_cuda_graphs(value);
  // @@protoc_insertion_point(field_set:xla.DebugOptions.xla_gpu_enable_cuda_graphs)
}
...
inline void ExecutionOptions::clear_allow_spmd_sharding_propagation_to_output() {
  _impl_.allow_spmd_sharding_propagation_to_output_ = false;
}
...
inline void ExecutionOptions::_internal_set_allow_spmd_sharding_propagation_to_output(bool value) {
  ...
  _impl_.allow_spmd_sharding_propagation_to_output_ = value;
}
...
inline bool HloModuleConfigProto::_internal_allow_spmd_sharding_propagation_to_output() const {
  return _impl_.allow_spmd_sharding_propagation_to_output_;
}
inline bool HloModuleConfigProto::allow_spmd_sharding_propagation_to_output() const {
  // @@protoc_insertion_point(field_get:xla.HloModuleConfigProto.allow_spmd_sharding_propagation_to_output)
  return _internal_allow_spmd_sharding_propagation_to_output();
}
inline void HloModuleConfigProto::_internal_set_allow_spmd_sharding_propagation_to_output(bool value) {
  
  _impl_.allow_spmd_sharding_propagation_to_output_ = value;
}
inline void HloModuleConfigProto::set_allow_spmd_sharding_propagation_to_output(bool value) {
  _internal_set_allow_spmd_sharding_propagation_to_output(value);
