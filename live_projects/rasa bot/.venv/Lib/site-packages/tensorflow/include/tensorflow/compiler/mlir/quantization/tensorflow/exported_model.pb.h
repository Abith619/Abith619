...
class ExportedModel final :
 ...
 public:
  ...
  private:
  int _internal_variable_shared_names_size() const;
  public:
  ...
  private:
  const std::string& _internal_variable_shared_names(int index) const;
  std::string* _internal_add_variable_shared_names();
  public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_restore_node_name(ArgT0&& arg0, ArgT... args);
  std::string* mutable_restore_node_name();
  PROTOBUF_NODISCARD std::string* release_restore_node_name();
  void set_allocated_restore_node_name(std::string* restore_node_name);
  private:
  const std::string& _internal_restore_node_name() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_restore_node_name(const std::string& value);
  std::string* _internal_mutable_restore_node_name();
  public:
...
inline void ExportedModel::clear_restore_node_name() {
  _impl_.restore_node_name_.ClearToEmpty();
}
inline const std::string& ExportedModel::restore_node_name() const {
  ...
  return _internal_restore_node_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ExportedModel::set_restore_node_name(ArgT0&& arg0, ArgT... args) {
 
 _impl_.restore_node_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* ExportedModel::mutable_restore_node_name() {
  std::string* _s = _internal_mutable_restore_node_name();
  // @@protoc_insertion_point(field_mutable:tensorflow.quantization.ExportedModel.restore_node_name)
  return _s;
}
inline const std::string& ExportedModel::_internal_restore_node_name() const {
  return _impl_.restore_node_name_.Get();
}
inline void ExportedModel::_internal_set_restore_node_name(const std::string& value) {
  
  _impl_.restore_node_name_.Set(value, GetArenaForAllocation());
}
inline std::string* ExportedModel::_internal_mutable_restore_node_name() {
  
  return _impl_.restore_node_name_.Mutable(GetArenaForAllocation());
}
inline std::string* ExportedModel::release_restore_node_name() {
  ...
  return _impl_.restore_node_name_.Release();
}
inline void ExportedModel::set_allocated_restore_node_name(std::string* restore_node_name) {
  ...
  _impl_.restore_node_name_.SetAllocated(restore_node_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.restore_node_name_.IsDefault()) {
    _impl_.restore_node_name_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
// repeated string variable_shared_names = 4;
inline int ExportedModel::_internal_variable_shared_names_size() const {
  return _impl_.variable_shared_names_.size();
}
inline int ExportedModel::variable_shared_names_size() const {
  return _internal_variable_shared_names_size();
}
inline void ExportedModel::clear_variable_shared_names() {
  _impl_.variable_shared_names_.Clear();
}
inline std::string* ExportedModel::add_variable_shared_names() {
  std::string* _s = _internal_add_variable_shared_names();
  // @@protoc_insertion_point(field_add_mutable:tensorflow.quantization.ExportedModel.variable_shared_names)
  return _s;
}
inline const std::string& ExportedModel::_internal_variable_shared_names(int index) const {
  return _impl_.variable_shared_names_.Get(index);
}
inline const std::string& ExportedModel::variable_shared_names(int index) const {
  ...
  return _internal_variable_shared_names(index);
}
inline std::string* ExportedModel::mutable_variable_shared_names(int index) {
  ...
  return _impl_.variable_shared_names_.Mutable(index);
}
inline void ExportedModel::set_variable_shared_names(int index, const std::string& value) {
  _impl_.variable_shared_names_.Mutable(index)->assign(value);
...
inline void ExportedModel::set_variable_shared_names(int index, std::string&& value) {
  _impl_.variable_shared_names_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:tensorflow.quantization.ExportedModel.variable_shared_names)
}
...
inline void ExportedModel::set_variable_shared_names(int index, const char* value, size_t size) {
  _impl_.variable_shared_names_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:tensorflow.quantization.ExportedModel.variable_shared_names)
}
inline std::string* ExportedModel::_internal_add_variable_shared_names() {
  return _impl_.variable_shared_names_.Add();
}
inline void ExportedModel::add_variable_shared_names(const std::string& value) {
  _impl_.variable_shared_names_.Add()->assign(value);
...
inline void ExportedModel::add_variable_shared_names(std::string&& value) {
  _impl_.variable_shared_names_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:tensorflow.quantization.ExportedModel.variable_shared_names)
}
...
inline void ExportedModel::add_variable_shared_names(const char* value, size_t size) {
  _impl_.variable_shared_names_.Add()->assign(reinterpret_cast<const char*>(value), size);
...
ExportedModel::variable_shared_names() const {
  ...
  return _impl_.variable_shared_names_;
}
