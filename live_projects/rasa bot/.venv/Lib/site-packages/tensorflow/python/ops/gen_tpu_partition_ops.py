...
@tf_export('tpu_partitioned_output_v2')
def tpu_partitioned_output_v2(inputs, num_splits, partition_dims, name=None):
  ...
  if tld.is_eager:
    try:
      ...
      pass
    try:
      _result = _dispatcher_for_tpu_partitioned_output_v2(
      ...
      _result = _dispatch.dispatch(
            tpu_partitioned_output_v2, (), dict(inputs=inputs,
...
_dispatcher_for_tpu_partitioned_output_v2 = tpu_partitioned_output_v2._tf_type_based_dispatcher.Dispatch
