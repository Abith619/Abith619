...
def data_service_dataset(dataset_id, processing_mode, address, protocol, job_name, max_outstanding_requests, iteration_counter, output_types, output_shapes, task_refresh_interval_hint_ms=-1, data_transfer_protocol="", target_workers="AUTO", cross_trainer_cache_options="", name=None):
...
def data_service_dataset_v2(dataset_id, processing_mode, address, protocol, job_name, consumer_index, num_consumers, max_outstanding_requests, iteration_counter, output_types, output_shapes, task_refresh_interval_hint_ms=-1, data_transfer_protocol="", target_workers="AUTO", cross_trainer_cache_options="", name=None):
  r"""Creates a dataset that reads data from the tf.data service.
...
def distributed_save(dataset, directory, address, metadata="", name=None):
  r"""TODO: add doc.
...
def random_dataset_v2(seed, seed2, seed_generator, output_types, output_shapes, rerandomize_each_iteration=False, metadata="", name=None):
  r"""Creates a Dataset that returns pseudorandom numbers.
