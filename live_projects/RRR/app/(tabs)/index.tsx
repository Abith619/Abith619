...
import { View, Image, Text, ScrollView, ImageBackground, TouchableOpacity, StyleSheet, Dimensions } from 'react-native';
    ...
    <SafeAreaProvider>
      <View style={{ flex: 1 }}>
        ...
        <SafeAreaView style={styles.container}>
          <ScrollView
            style={{ flex: 1 }}
            contentContainerStyle={{ paddingHorizontal: 10, paddingBottom: 120, flexGrow: 1 }}
          >
            <ImageBackground
              source={require('@/assets/images/destroyed_city.png')}
            ...
            >
              <View style={{...styles.textContainer, paddingBottom: 50}}>
                ...
                <Text style={styles.location}>Orange County Convention Center{"\n"}Orlando, FL</Text>
              </View>
                ...
                <TouchableOpacity
                  ...
                  style={[styles.joinNowButton, pressed && styles.trapezoidButtonPressed]}
                >
          ...
          <View style={{ paddingHorizontal: 0 }}>
            ...
            <Text style={styles.RedTitle}>
              ...
              <View style={styles.row}>
                ...
                <View style={styles.col}>
                  <Text style={styles.DesTitleWhite}>
                    To challenge outdated trade show models by providing real value, networking, and
                    immediate ROI for brands, retailers, and investors.
                  </Text>
                </View>
              </View>
              ...
              <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                <View style={styles.scrollContainer}>{cards}</View>
              </ScrollView>
              <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                <View style={styles.scrollContainer}>{cardSponsors}</View>
              </ScrollView>
            </View>
          </ScrollView>
        </SafeAreaView>
