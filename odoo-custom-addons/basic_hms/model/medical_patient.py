...
#                               Invoice
    ...
    treatment = fields.Selection([('diabets','Diabets'),('feaver','Feaver')],string="Treatment for")
    ...
    data_value = fields.Many2many('medical.feedback', string="How do you came to know about Daisy Health Care (P) LTD.,?")
    @api.model
    def create(self,val):
