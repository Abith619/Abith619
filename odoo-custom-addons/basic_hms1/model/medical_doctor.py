...
class medical_directions(models.Model):
    ...
    doctor = fields.Many2one('res.partner',domain=[('is_doctor','=',True)],string="Doctor" ,track_visibility='always',readonly=True)
    age=fields.Char(string='Age',readonly=True)
    address = fields.Char(string="Address",readonly=True)
    marital_status = fields.Selection([('s','Single'),('m','Married'),('w','Widowed'),('d','Divorced'),('x','Seperated')],string='Marital Status',readonly=True)
    height = fields.Float(string="Height in Cms",readonly=True)
    weight = fields.Float(string="Weight in Kgs",readonly=True)
    ...
    patient = fields.Many2one('res.partner',domain=[('is_patient','=',True)],string="Patient",required=True,readonly=True)
    ...
    sex = fields.Selection([('m', 'Male'),('f', 'Female')],  string ="Sex", required= True,readonly=True)
    ...
    office_address = fields.Text(string="Office Address",readonly=True)

#new fields 
    father_name=fields.Char(string="Father/Husband/Guardian",readonly=True)
    image = fields.Binary()
    ...
    phone_number=fields.Char(string="Contact Number",readonly=True)
